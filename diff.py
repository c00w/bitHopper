    ...
    def update_difficulty(self):
        while True:
            ...
            with self.lock:
                ...
                self.updater("IXcoin", 'http://74.207.237.83/allchains.info', 'ixc_difficulty', "ixc </td><td align='right'> ([0-9]+) </td><td align='right'>   [.0-9]+ </td>")
                self.updater("I0coin", 'http://74.207.237.83/allchains.info', 'i0c_difficulty', "i0c </td><td align='right'> ([0-9]+) </td><td align='right'>   [.0-9]+ </td>")
